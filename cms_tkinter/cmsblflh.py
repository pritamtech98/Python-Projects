...
class Customer:
    ...
    def add_Customer(self):
        ...
        if(m!=None):
            ...
            return 3
        f=open("E://custlist.txt", "wb+")#mycursor.execute("insert into customer values('%s', '%s', %d, %d, '%s', '%s');"%(self.custId, self.custName, self.custAge, self.custMob, self.custPassword, self.custPhoto))
