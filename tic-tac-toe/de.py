...
class loginFrame(Frame):
    ...
    def action_start(self):
        ...
        mainFrame(self.top, [self.frame1.var_name.get(), self.frame1.var_age.get(), self.frame1.var_email.get()],
                  [self.frame2.var_name.get(), self.frame2.var_age.get(), self.frame2.var_email.get()],
                  int(self.container_frame.combo_round.get()))

    def combo_listener(self, event):
        pass

    def createwidget(self):
        self.heading_frame = Frame(self, bg='light grey')
        self.heading_frame.pack(pady=10, padx=8)
        self.heading_frame.lbl = Label(self.heading_frame, text="Welcome to my tic-tac-toe game",
                                       font='arial 20 bold italic', bg='light grey', fg='grey')
        ...
        self.frame1.grid(row=0, column=0, padx=6, pady=4)
        self.frame2.grid(row=0, column=1, padx=6, pady=4)
        ...
        self.frame1.btn_submit = tkinter.ttk.Checkbutton(self.frame1, text="All filled", variable=self.frame1.var_chk1,
        ...
        self.container_frame.btn_start = tkinter.ttk.Button(self.container_frame, text="Start", width=50,
                                                            padding=(10, 5), command=self.action_start)
...
class mainFrame(Frame):
    ...
    def do_monitor(self, x, y):
        ...
        if (mainFrame.cur_round > self.no_of_rounds):
            if (self.player1_score > self.player2_score):
                ...
                tkinter.messagebox.showinfo("Match drawn")
            self.master.destroy()
    ...
    def show_frames(self):
        ...
        self.frame_turn.lbl_round = Label(self.frame_turn, text="Round :" + str(mainFrame.cur_round),
                                          font='arial 10 bold', bg='#E5E5E5')
    ...
    def createWidget(self):
        ...
        self.side_frame.lbl_name1 = Label(self.side_frame.frame1,
                                          text="Player 1 :  " + str(self.player1[0]).lower().capitalize(),
                                          font='arial 8 bold')
        ...
        self.side_frame.lbl_name2 = Label(self.side_frame.frame2,
                                          text="Player 2 :  " + str(self.player2[0]).lower().capitalize(),
                                          font='arial 8 bold')
